    ...
    require(['domReady!'],function(avalon){
        var vm=avalon.define({
            ...
            caculate:function(){
                ...
                $(".order-type,.order-con").height(height-oDetail*2-oBottom-50);
                //simpScroller(document.querySelector(".order-ul"));
            ...
            settlementFn:function(){
                ...
                dataArr.forEach(function(el){
                    json['items['+el.code+']']=el.num;
                });

                jsonp(host+'/jsonp/Order_InsertItem_'+vm.version+'.js',json,'callback',function(rs){
                    if(rs.Success){
                        $.message({
                            msg:'录入商品成功!',
                            callback:function(){
                                window.location.href = getLocalstorage('inComLink');
                            }
                        })
                    }else{
                        $.message({
