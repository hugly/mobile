    ...
    require(['mmRequest','domReady!'],function(avalon){
        var vm=avalon.define({
            ...
            chooseAddress:function(type){
                ...
                if(vm.addType === 'pickup'){
                    vm.urlData=jsonInList({'pcikupnowLat':vm.nowLat},vm.urlData);
                    vm.urlData=jsonInList({'pcikupnowLng':vm.nowLng},vm.urlData);
                    vm.urlData=jsonInList({'pcikupaddress':vm.address},vm.urlData);
                    vm.searchData=transList2Url(vm.urlData.$model);
                }else if(vm.addType === 'send'){
                    vm.urlData=jsonInList({'sendnowLat':vm.nowLat},vm.urlData);
                    vm.urlData=jsonInList({'sendnowLng':vm.nowLng},vm.urlData);
                    vm.urlData=jsonInList({'sendaddress':vm.address},vm.urlData);
                    vm.searchData=transList2Url(vm.urlData.$model);
                }
